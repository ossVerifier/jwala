...
public enum PropertyKeys {
    ...
    SCRIPTS_PATH(ApplicationProperties.get(PropertyKeys.SCRIPTS_PATH)),
    ...
    PATHS_RESOURCE_TEMPLATES(ApplicationProperties.get(PropertyKeys.PATHS_RESOURCE_TEMPLATES)),
