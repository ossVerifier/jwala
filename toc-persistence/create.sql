...
CREATE TABLE history (id INTEGER NOT NULL IDENTITY, createBy VARCHAR(255), createDate TIMESTAMP, lastUpdateDate TIMESTAMP, name VARCHAR(255) NOT NULL, updateBy VARCHAR(255), event VARCHAR(255), groupId BIGINT, CONSTRAINT U_HISTORY_NAME UNIQUE (name), CONSTRAINT U_HISTORY_ID UNIQUE (id));
