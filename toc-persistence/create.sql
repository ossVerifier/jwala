...
CREATE TABLE GRP_APP_CONFIG_TEMPLATE (ID INTEGER NOT NULL IDENTITY, TEMPLATE_CONTENT VARCHAR(2147483647) NOT NULL, TEMPLATE_NAME VARCHAR(255) NOT NULL, GRP_ID BIGINT, CONSTRAINT U_GRP_PLT_GRP_ID2 UNIQUE (GRP_ID, TEMPLATE_NAME));
...
CREATE TABLE GRP_WEBSERVER_CONFIG_TEMPLATE (ID INTEGER NOT NULL IDENTITY, TEMPLATE_CONTENT VARCHAR(2147483647) NOT NULL, TEMPLATE_NAME VARCHAR(255) NOT NULL, GRP_ID BIGINT, CONSTRAINT U_GRP_PLT_GRP_ID1 UNIQUE (GRP_ID, TEMPLATE_NAME));
