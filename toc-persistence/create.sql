...
CREATE TABLE jvm (id INTEGER NOT NULL IDENTITY, createBy VARCHAR(255), createDate TIMESTAMP, lastUpdateDate TIMESTAMP, updateBy VARCHAR(255), ajpPort INTEGER NOT NULL, ERR_STS VARCHAR(2147483647), hostName VARCHAR(255), httpPort INTEGER NOT NULL, httpsPort INTEGER, name VARCHAR(255) NOT NULL, redirectPort INTEGER NOT NULL, shutdownPort INTEGER NOT NULL, state VARCHAR(20), statusPath VARCHAR(255) NOT NULL, systemProperties VARCHAR(255), CONSTRAINT U_JVM_NAME UNIQUE (name));
