...
CREATE TABLE APP_CONFIG_TEMPLATE (ID INTEGER NOT NULL IDENTITY, TEMPLATE_CONTENT VARCHAR(2147483647) NOT NULL, TEMPLATE_NAME VARCHAR(255) NOT NULL, APP_ID BIGINT, JVM_ID BIGINT, CONSTRAINT U_PP_CPLT_APP_ID UNIQUE (APP_ID, TEMPLATE_NAME));
...
CREATE TABLE GRP_APP_CONFIG_TEMPLATE (ID INTEGER NOT NULL IDENTITY, TEMPLATE_CONTENT VARCHAR(2147483647) NOT NULL, TEMPLATE_NAME VARCHAR(255) NOT NULL, GRP_ID BIGINT, CONSTRAINT U_GRP_PLT_GRP_ID1 UNIQUE (GRP_ID, TEMPLATE_NAME));
CREATE TABLE GRP_JVM (GROUP_ID BIGINT, JVM_ID BIGINT, CONSTRAINT U_GRP_JVM_GROUP_ID UNIQUE (GROUP_ID, JVM_ID));
CREATE TABLE GRP_JVM_CONFIG_TEMPLATE (ID INTEGER NOT NULL IDENTITY, TEMPLATE_CONTENT VARCHAR(2147483647) NOT NULL, TEMPLATE_NAME VARCHAR(255) NOT NULL, GRP_ID BIGINT, CONSTRAINT U_GRP_PLT_GRP_ID UNIQUE (GRP_ID, TEMPLATE_NAME));
CREATE TABLE GRP_WEBSERVER_CONFIG_TEMPLATE (ID INTEGER NOT NULL IDENTITY, TEMPLATE_CONTENT VARCHAR(2147483647) NOT NULL, TEMPLATE_NAME VARCHAR(255) NOT NULL, GRP_ID BIGINT, CONSTRAINT U_GRP_PLT_GRP_ID2 UNIQUE (GRP_ID, TEMPLATE_NAME));
...
CREATE TABLE jvm (id INTEGER NOT NULL IDENTITY, createBy VARCHAR(255), createDate TIMESTAMP, lastUpdateDate TIMESTAMP, updateBy VARCHAR(255), ajpPort INTEGER NOT NULL, ERR_STS VARCHAR(2147483647), hostName VARCHAR(255), httpPort INTEGER NOT NULL, httpsPort INTEGER, name VARCHAR(255) NOT NULL, redirectPort INTEGER NOT NULL, shutdownPort INTEGER NOT NULL, STATE VARCHAR(255), statusPath VARCHAR(255) NOT NULL, systemProperties VARCHAR(255), CONSTRAINT U_JVM_NAME UNIQUE (name));
...
CREATE TABLE webserver (id INTEGER NOT NULL IDENTITY, createBy VARCHAR(255), createDate TIMESTAMP, lastUpdateDate TIMESTAMP, updateBy VARCHAR(255), docRoot VARCHAR(255) NOT NULL, ERR_STS VARCHAR(2147483647), host VARCHAR(255), httpConfigFile VARCHAR(255) NOT NULL, httpsPort INTEGER, name VARCHAR(255), port INTEGER, STATE VARCHAR(255), statusPath VARCHAR(255) NOT NULL, svrRoot VARCHAR(255) NOT NULL, CONSTRAINT U_WBSRVER_NAME UNIQUE (name));
...
CREATE TABLE WEBSERVER_GRP (GROUP_ID BIGINT, WEBSERVER_ID BIGINT);
