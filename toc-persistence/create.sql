...
CREATE TABLE history (id INTEGER NOT NULL IDENTITY, createBy VARCHAR(255), createDate TIMESTAMP, lastUpdateDate TIMESTAMP, updateBy VARCHAR(255), event CLOB, EVENTTYPE VARCHAR(2), serverName VARCHAR(255) NOT NULL, groupId BIGINT, CONSTRAINT U_HISTORY_ID UNIQUE (id));
