...
ALTER TABLE JVM ADD COLUMN IF NOT EXISTS statusPath VARCHAR(255) DEFAULT '/stp.png';
...
ALTER TABLE WEBSERVER ADD COLUMN IF NOT EXISTS httpConfigFile VARCHAR(255) DEFAULT 'd:/stp/app/data/httpd/httpd.conf';
