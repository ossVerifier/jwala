...
CREATE TABLE current_state (ID BIGINT NOT NULL, TYPE VARCHAR(255) NOT NULL, AS_OF TIMESTAMP NOT NULL, MESSAGE VARCHAR(20000), STATE VARCHAR(255) NOT NULL, PRIMARY KEY (ID, TYPE));
...
CREATE TABLE jvm (id INTEGER NOT NULL IDENTITY, createBy VARCHAR(255), createDate TIMESTAMP, lastUpdateDate TIMESTAMP, name VARCHAR(255) NOT NULL, updateBy VARCHAR(255), ajpPort INTEGER NOT NULL, hostName VARCHAR(255), httpPort INTEGER NOT NULL, httpsPort INTEGER, redirectPort INTEGER NOT NULL, shutdownPort INTEGER NOT NULL, statusPath VARCHAR(255) NOT NULL, CONSTRAINT U_JVM_NAME UNIQUE (name));
...
CREATE TABLE webserver (id INTEGER NOT NULL IDENTITY, createBy VARCHAR(255), createDate TIMESTAMP, lastUpdateDate TIMESTAMP, name VARCHAR(255) NOT NULL, updateBy VARCHAR(255), host VARCHAR(255), httpConfigFile VARCHAR(255) NOT NULL, httpsPort INTEGER, port INTEGER, statusPath VARCHAR(255) NOT NULL, CONSTRAINT U_WBSRVER_NAME UNIQUE (name));
