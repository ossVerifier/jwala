...
CREATE TABLE current_state (ID BIGINT NOT NULL, TYPE VARCHAR(255) NOT NULL, AS_OF TIMESTAMP NOT NULL, MESSAGE VARCHAR(255), STATE VARCHAR(255) NOT NULL, PRIMARY KEY (ID, TYPE));
