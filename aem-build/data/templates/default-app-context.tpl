...
<Context docBase="\${STP_HOME}/app/webapps/@healthcheck.webapp.file.name@">
    ...
    <Environment name="jvmInstanceName"
                 value="${webApp.jvm.jvmName}"
                 type="java.lang.String"
                 override="false"/>

    <Environment name="roleMappingProperties"
        value="${STP_HOME}/@stp.properties.relativedir@/hctRoleMapping.properties"
        type="java.lang.String"
        override="false" />
