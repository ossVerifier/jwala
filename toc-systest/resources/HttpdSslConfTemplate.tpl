...
#SSLPassPhraseDialog "exec:../@stp.internal.dirname@/data/security/apache/authorize.bat"
...
IncludeOptional ../@stp.internal.dirname@/data/httpd/*urlrewriterules.conf
...
SSLCertificateFile ../@stp.internal.dirname@/data/security/id/${webServer.host}.cer
SSLCertificateKeyFile ../@stp.internal.dirname@/data/security/id/${webServer.host}.key
...
SSLProxyCACertificatePath ../@stp.internal.dirname@/data/security/openssl/
