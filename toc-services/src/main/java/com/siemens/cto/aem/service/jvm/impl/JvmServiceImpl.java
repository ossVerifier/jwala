...
public class JvmServiceImpl implements JvmService {
    ...
    @Override
    public int generateResourceFiles(final String jvmName, final String destPath) throws IOException {
     ...
     * @throws IOException
     */
    protected void createConfigFile(final String path, final String configFileName, final String generatedResourceStr) throws IOException {
        File serverXml = new File(path + configFileName);
        FileUtils.writeStringToFile(serverXml, generatedResourceStr);
    }
}
