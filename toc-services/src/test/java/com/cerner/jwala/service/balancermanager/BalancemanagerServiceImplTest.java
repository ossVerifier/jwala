...
import com.cerner.jwala.service.balancermanager.impl.BalancemanagerHttpClient;
...
public class BalancemanagerServiceImplTest {
    ...
    public void testCheckStatusFail() {
        ...
        try {
            ...
            assertEquals("com.cerner.jwala.common.exception.InternalErrorException: The target Web Server myWebSererName must be start before attempting to drain user", e.toString());
        }
    }
    ...
    public void testCheckGroupStatusFail() {
        ...
        try {
            ...
            assertEquals("com.cerner.jwala.common.exception.InternalErrorException: The target Web Server myWebServerName in group mygroupName must be start before attempting to drain user", e.toString());
        }
    }
