...
public class ResourceServiceImplTest {
    ...
    ResourceService cut = new ResourceServiceImpl(Mockito.mock(TemplateManager.class), Mockito.mock(HarmonyTemplateEngine.class), Mockito.mock(ResourcePersistenceService.class), Mockito.mock(GroupPersistenceService.class));
