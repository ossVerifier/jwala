...
SET TOMCAT_CORE_BIN_DIR=%CATALINA_HOME%\core\bin
...
CMD /C %TOMCAT_CORE_BIN_DIR%\service.bat install ${jvm.jvmName}
...
CMD /C  %TOMCAT_CORE_BIN_DIR%\tomcat7 //US//${jvm.jvmName} --JavaHome ${vars['remote.jwala.java.home']} %SERVICE_OPTS% --StdOutput "" --StdError ""
``
