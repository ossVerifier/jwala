...
@Entity(name = "webserver_control_history")
public class JpaWebServerControlHistory implements Serializable {
    ...
    public void setWebServerId(final Long webServerId) {
    ...
    public boolean equals(final Object o) {
        ...
        final JpaWebServerControlHistory that = (JpaWebServerControlHistory) o;
