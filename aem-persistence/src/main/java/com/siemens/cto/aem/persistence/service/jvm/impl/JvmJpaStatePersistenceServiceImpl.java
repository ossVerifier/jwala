...
import com.siemens.cto.aem.persistence.service.webserver.impl.WebServerJpaCurrentStateBuilder;
...
public class JvmJpaStatePersistenceServiceImpl extends JpaStatePersistenceServiceImpl<Jvm, JvmState> implements StatePersistenceService<Jvm, JvmState> {
    ...
    @Override
    protected CurrentState<Jvm, JvmState> build(final JpaCurrentState aCurrentState) {
        return new JvmJpaCurrentStateBuilder(aCurrentState).build();
    }
}
