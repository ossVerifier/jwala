...
CREATE TABLE JVM_CONFIG_TEMPLATE (ID INTEGER NOT NULL IDENTITY, TEMPLATE_CONTENT VARCHAR(255) NOT NULL, TEMPLATE_NAME VARCHAR(255) NOT NULL, JVM_ID BIGINT, CONSTRAINT U_JVM_PLT_JVM_ID UNIQUE (JVM_ID, TEMPLATE_NAME));
