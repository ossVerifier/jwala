CREATE TABLE app (ID INTEGER NOT NULL IDENTITY, createBy VARCHAR(255), createDate TIMESTAMP, lastUpdateDate TIMESTAMP, name VARCHAR(255) NOT NULL, updateBy VARCHAR(255), documentRoot VARCHAR(255), secure BOOLEAN, warPath VARCHAR(255), webAppContext VARCHAR(255) NOT NULL, GROUP_ID BIGINT, CONSTRAINT U_APP_NAME UNIQUE (name));
