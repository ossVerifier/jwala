...
CREATE TABLE RESOURCE_INSTANCE (RESOURCE_INSTANCE_ID INTEGER NOT NULL IDENTITY, createBy VARCHAR(255), createDate TIMESTAMP, lastUpdateDate TIMESTAMP, name VARCHAR(255), updateBy VARCHAR(255), RESOURCE_TYPE_NAME VARCHAR(255), GROUP_ID BIGINT, CONSTRAINT U_RSRCTNC_NAME UNIQUE (name), CONSTRAINT U_RSRCTNC_RESOURCE_INSTANCE_ID UNIQUE (RESOURCE_INSTANCE_ID));
