...
public class JvmCommandFactory {
    ...
    private void copyScriptToRemoteDestination(Jvm jvm, String scriptName, String destAbsolutePath) {
        ...
        CommandOutput copyResult = binaryDistributionControlService.secureCopyFile(jvm.getHostName(), ApplicationProperties.getRequired(PropertyKeys.SCRIPTS_PATH) + "/" + scriptName, destAbsolutePath);
