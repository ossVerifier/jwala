...
public class JvmServiceImplTest extends VerificationBehaviorSupport {
    ...
    public void testPreviewTemplate() {
        ...
        Jvm testJvm = new Jvm(new Identifier<Jvm>(111L), jvmName, "testHost", new HashSet<Group>(), 9101, 9102, 9103, -1, 9104, new Path("./"), "", JvmState.JVM_STOPPED, "", null, null, null, null, null, null);
        List<Jvm> jvmList = new ArrayList<>();
        jvmList.add(testJvm);
