...
public interface WebServerCommandExecutor {
    ...
    CommandOutput controlWebServer(final ControlWebServerRequest controlWebServerRequest, final WebServer aJvm, String... params) throws CommandFailureException;
}
